...
while True: # The main program loop
    ...
    for y in range(HEIGHT):
        for x in range(WIDTH):
            print(currentCells[x][y], end='')   # Print the # or the empty space
    ...
    for x in range(WIDTH):
        for y in range(HEIGHT):
            ...
            # `% WIDTH` endusres leftCoord is always between 0 and WIDTH-1
            leftCoord = (x-1) % WIDTH
            ...
            if currentCells[x][y] == "#" and (numNeighbors == 2 or numNeighbors == 3):
                ...
                # Everything else stays alive or stays dead
                nextCells[x][y] = " "
